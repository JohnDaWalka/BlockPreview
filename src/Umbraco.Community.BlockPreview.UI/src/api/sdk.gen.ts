...
export class BlockPreviewService {
    public static previewGridBlock<ThrowOnError extends boolean = true>(options?: Options<PreviewGridBlockData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<PreviewGridBlockResponses, PreviewGridBlockErrors, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
    ...
    public static previewListBlock<ThrowOnError extends boolean = true>(options?: Options<PreviewListBlockData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<PreviewListBlockResponses, PreviewListBlockErrors, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
    ...
    public static previewRichTextMarkup<ThrowOnError extends boolean = true>(options?: Options<PreviewRichTextMarkupData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<PreviewRichTextMarkupResponses, PreviewRichTextMarkupErrors, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
